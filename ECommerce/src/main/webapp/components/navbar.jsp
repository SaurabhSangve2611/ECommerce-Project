    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="index.jsp?category=2">Mobile Phones</a>
          <a class="dropdown-item" href="index.jsp?category=3">Cloths</a>
           <a class="dropdown-item" href="index.jsp?category=4">Electronics</a>
